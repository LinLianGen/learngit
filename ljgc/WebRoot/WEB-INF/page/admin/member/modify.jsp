							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="username"
										...
										value="${v.username}" placeholder="请输入用户名名称" required
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="tel"
										<c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.tel}" placeholder="请输入手机号码名称" required
										lay-verify="required" autocomplete="off" class="layui-input">
								</div>
							</div>
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="nickname"
										<c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.nickname}" placeholder="请输入昵称/公司名称名称" required
										lay-verify="required" autocomplete="off" class="layui-input">
								</div>
							</div>
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="quota"
											<c:if test="${op eq 'see'}">disabled="disabled"</c:if>
											value="${v.quota}" placeholder="" required
											lay-verify="required" autocomplete="off" class="layui-input">
									</div>
								</div>
							</c:if>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="money"
										<c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.money}" placeholder="请输入余额名称" required
										lay-verify="required" autocomplete="off" class="layui-input">
								</div>
							</div>
