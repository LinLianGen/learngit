				...
				<div class="ibox float-e-margins">
					<div class="ibox-content layui-form">
						...
						<%-- 	<div class="layui-form-item">
							 ...
							 --%>
							<div class="layui-form-item">
								<label class="layui-form-label">注册押金设置</label>
								<div class="layui-input-block">
									<input type="text" name="deposit" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.deposit}" placeholder="请输入名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
