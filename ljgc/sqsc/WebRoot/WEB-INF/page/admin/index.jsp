...
<link href="css/layui/layui.mobile.css" rel="stylesheet">
</head>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row content-tabs">
				...
				<a href="${sysUrl }logout" class="roll-nav roll-right J_tabExit"><i
			...
			<div class="footer">
				<div class="pull-right">
					...
					<a href="http://www.maitomweb.com/" target="_blank">麦唐科技</a>
				</div>
			</div>
		</div>
	</div>
