					...
					<div class="ibox-content layui-form">
						<form class="layui-form" action="">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="address" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.address}" placeholder="请输入详细地址名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="is_default" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.is_default}" placeholder="请输入是否默认名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
							...
							<div class="layui-form-item">
								<label class="layui-form-label">用户小区ID</label>
								<div class="layui-input-block">
									<input type="text" name="communityId" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.communityId}" placeholder="请输入用户小区ID名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
