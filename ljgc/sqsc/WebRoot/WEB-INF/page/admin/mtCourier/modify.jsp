							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="password" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.password}" placeholder="请输入登录密码名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
							
							<div class="layui-form-item">
								<label class="layui-form-label">小哥昵称</label>
								<div class="layui-input-block">
									<input type="text" name="user_name" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.user_name}" placeholder="请输入小哥昵称名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
							
							<div class="layui-form-item">
								<label class="layui-form-label">小哥头像</label>
								<div class="layui-input-block">
									<input type="text" name="img" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.img}" placeholder="请输入小哥头像名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="status" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.status}" placeholder="请输入工作状态名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
