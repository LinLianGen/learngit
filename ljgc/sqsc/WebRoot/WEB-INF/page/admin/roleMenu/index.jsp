									...
									<form class="form-inline" id="searchForm">
										...
										<div class="form-group">
											<div class="input-group">
												<input class="form-control" name="roleMenuId" type="text"
													placeholder="请输入">
											</div>
										</div>
										...
										<div class="form-group">
											<div class="input-group">
												<input class="form-control" name="menuId" type="text"
													placeholder="请输入菜单ID">
											</div>
										</div>
										...
										<div class="form-group">
											<div class="input-group">
												<input class="form-control" name="roleId" type="text"
													placeholder="请输入">
											</div>
										</div>
