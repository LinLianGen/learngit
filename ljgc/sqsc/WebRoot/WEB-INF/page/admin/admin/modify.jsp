				...
				<div class="ibox float-e-margins">
					<div class="ibox-content layui-form">
						<form class="layui-form" action="">
							<input type="hidden" name="adminId" value="${v.adminId}"
								class="layui-input">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="userName"
										...
										value="${v.userName}" placeholder="请输入登陆名名称" required
								...
								<div class="layui-input-block">
									<select name="userRole" lay-verify="required"
										...
										<c:forEach items="${v.list }" var="l">
											<option value="${l.id }"
												<c:if test="${v.userRole eq l.id }">selected="selected"</c:if>>${l.name }</option>
										</c:forEach>
									</select>
								</div>
							</div>
