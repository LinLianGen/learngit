...
public class SmsDemo {
	...
	static final String accessKeyId = "LTAITXpqPuSkhCNc";
	//
	static final String accessKeySecret = "sofws83VwJrnY9B1hboKgHk14Uspwn";

	public static SendSmsResponse sendSms(String telephone, String code ,String SMS_117515)
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("脸盆宝");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode(SMS_117515);
		// 可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
		if(SMS_117515.equals("SMS_33640328")){
	...
	public static QuerySendDetailsResponse querySendDetails(String bizId)
		...
		// 必填-号码
		request.setPhoneNumber("18651609384");
		// 可选-流水号
	...
	public static boolean handleMsg(String phone, String code ,String  SMS_117515)
			throws ClientException, InterruptedException {
		boolean sendFlag = false;
		SendSmsResponse response = sendSms(phone, code, SMS_117515);
	...
	public static void main(String[] args) throws ClientException,
		...
		// 发短信
		SendSmsResponse response = sendSms("13814541520", "6666", "SMS_33640328");
