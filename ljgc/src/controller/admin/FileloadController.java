...
public class FileloadController extends CRUD {
	...
	public void uploadImg() {
		...
		renderJSON(UploadUtils.uploadFile(files, ".jpg|.png|.jpeg", 1024 * 10));
	}
	...
	public void uploadVersion() {
		List<UploadFile> files = getFiles();
		renderJSON(UploadUtils.uploadFileSe(files, ".apk|.ipa", 1024 * 30));
	}
	...
	* @修改:
	*/ 
	public void uploadExcal() {
		List<UploadFile> files = getFiles();
		renderJSON(UploadUtils.uploadFileSe(files, ".xls|.xlsx", 1024 * 20));
	}
